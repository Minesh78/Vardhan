  ...
  return (
    ...
    <div className=' w-full fixed top-0 left-0 z-10'>
      ...
      <div className=' font-bold text-2xl cursor-pointer flex  items-center  text-white'>
        ...
        <NavLink to="/" className='text-[#904B55] hover:text-[#832230] duration-500'>V Vardhan Architects & Associates</NavLink>
      </div>
      ...
      <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static  md:z-auto z-[-1] left-0 w-full  md:w-auto md:pl-0 pl-9 backdrop-blur-sm transition-all duration-500  ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
